      ...
      <div className="content-container section-padding-sm">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 text-sm text-muted-foreground leading-relaxed max-w-xs">
              {siteConfig.tagline} A connected initiative within the Bahamas
              Chamber of Commerce and Employers’ Confederation ecosystem.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href={siteConfig.footer.social.linkedin}
              className="text-muted-foreground hover:text-foreground transition-colors"
              aria-label="LinkedIn"
            >
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
