...
export default function Directory() {
  ...
  const industries = Array.from(
    new Set(members.map((member) => member.industry)),
  ).sort();
    ...
    return members
      .filter((member) => {
        ...
        return (
          ...
          (industry === "all" || member.industry === industry) &&
          (location === "all" || member.location === location)
        );
      })
      .sort((a, b) =>
        sort === "newest"
        ...
        <div className="content-container">
            ...
            <div className="grid gap-3 md:grid-cols-[1.4fr_1fr_1fr_0.8fr]">
              <label className="relative block">
                ...
                <Input
                  ...
                  placeholder="Search name, business, service, or keyword"
          ...
          <div className="mt-8 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
            <p className="text-sm text-muted-foreground">
              Showing {filteredMembers.length} approved{" "}
          ...
          {filteredMembers.length > 0 ? (
            ...
            <div className="mt-8 rounded-[1.75rem] border border-dashed border-border bg-muted/50 p-10 text-center">
              ...
              <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
                Try a different keyword, adjust your filters, or check back as
                more YPS profiles are approved.
              </p>
            </div>
          )}
        </div>
